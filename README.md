...
| `images.format` | `png` | The format used to store images. Can be set to one of the following: `png`, `jpeg` or `avif`. Note: AVIF is not yet supported in every modern browser, see [Can I use AVIF](https://caniuse.com/avif) for more information. |
