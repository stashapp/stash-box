...
func GenerateInviteKeys(uf FinderUpdater, ic models.InviteKeyCreator, userID uuid.UUID, input *models.GenerateInviteCodeInput, useToken bool) ([]uuid.UUID, error) {
	keys := 1
	if input.Keys != nil {
		keys = *input.Keys
	}
