...
func (s *editTestRunner) testApplyCreateTagEdit() {
	name := "Name"
	description := "Description"
	tagEditDetailsInput := models.TagEditDetailsInput{
		Name:        &name,
...
func (s *editTestRunner) verifyAppliedTagCreateEdit(input models.TagEditDetailsInput, edit *models.Edit) {
	r := s.resolver.Edit()
...
func (s *editTestRunner) testApplyModifyTagEdit() {
...
func (s *editTestRunner) verifyApplyModifyTagEdit(input models.TagEditDetailsInput, updatedTag *models.Tag, edit *models.Edit) {
	s.verifyEditOperation(models.OperationEnumModify.String(), edit)
	s.verifyEditStatus(models.VoteStatusEnumImmediateAccepted.String(), edit)
	s.verifyEditTargetType(models.TargetTypeEnumTag.String(), edit)
	s.verifyEditApplication(true, edit)
...
func (s *editTestRunner) testApplyDestroyTagEdit() {
	createdTag, err := s.createTestTag(nil)
	if err != nil {
		return
	}
...
func (s *editTestRunner) verifyApplyDestroyTagEdit(destroyedTag *models.Tag, edit *models.Edit, scene *models.Scene) {
	s.verifyEditOperation(models.OperationEnumDestroy.String(), edit)
	s.verifyEditStatus(models.VoteStatusEnumImmediateAccepted.String(), edit)
	s.verifyEditTargetType(models.TargetTypeEnumTag.String(), edit)
	s.verifyEditApplication(true, edit)
...
func (s *editTestRunner) testApplyMergeTagEdit() {
...
func (s *editTestRunner) verifyAppliedMergeTagEdit(input models.TagEditDetailsInput, edit *models.Edit, scene1 *models.Scene, scene2 *models.Scene) {
	s.verifyEditOperation(models.OperationEnumMerge.String(), edit)
	s.verifyEditStatus(models.VoteStatusEnumImmediateAccepted.String(), edit)
	s.verifyEditTargetType(models.TargetTypeEnumTag.String(), edit)
	s.verifyEditApplication(true, edit)
