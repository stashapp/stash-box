...
export interface StudioEdit_studioEdit_target_Scene_date {
  __typename: "FuzzyDate";
  date: any;
  accuracy: DateAccuracyEnum;
}
...
export interface StudioEdit_studioEdit_target_Scene {
  __typename: "Scene";
  id: string;
  date: StudioEdit_studioEdit_target_Scene_date | null;
  title: string | null;
  deleted: boolean;
  details: string | null;
...
export interface StudioEdit_studioEdit_merge_sources_Scene_date {
  __typename: "FuzzyDate";
  date: any;
  accuracy: DateAccuracyEnum;
}
...
export interface StudioEdit_studioEdit_merge_sources_Scene {
  __typename: "Scene";
  id: string;
  date: StudioEdit_studioEdit_merge_sources_Scene_date | null;
  title: string | null;
  deleted: boolean;
  details: string | null;
  director: string | null;
