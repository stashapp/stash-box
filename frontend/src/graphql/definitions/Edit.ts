...
export interface Edit_findEdit_user_vote_count {
...
export interface Edit_findEdit_user_edit_count {
...
export interface Edit_findEdit_user {
   ...
   *  Vote counts by type 
   */
  vote_count: Edit_findEdit_user_vote_count;
  /**
   *  Edit counts by status 
   */
  edit_count: Edit_findEdit_user_edit_count;
}
