...
export interface Edits_queryEdits_edits_user_vote_count {
...
export interface Edits_queryEdits_edits_user_edit_count {
...
export interface Edits_queryEdits_edits_user {
   ...
   *  Vote counts by type 
   */
  vote_count: Edits_queryEdits_edits_user_vote_count;
  /**
   *  Edit counts by status 
   */
  edit_count: Edits_queryEdits_edits_user_edit_count;
}
