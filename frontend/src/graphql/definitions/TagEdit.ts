...
export interface TagEdit_tagEdit_target_Scene_date {
  __typename: "FuzzyDate";
  date: any;
  accuracy: DateAccuracyEnum;
}
...
export interface TagEdit_tagEdit_target_Scene {
  __typename: "Scene";
  id: string;
  date: TagEdit_tagEdit_target_Scene_date | null;
  title: string | null;
  deleted: boolean;
  details: string | null;
...
export interface TagEdit_tagEdit_details_SceneEdit_added_fingerprints {
  __typename: "Fingerprint";
  hash: string;
  algorithm: FingerprintAlgorithm;
  duration: number;
...
export interface TagEdit_tagEdit_details_SceneEdit_removed_fingerprints {
  __typename: "Fingerprint";
  hash: string;
  algorithm: FingerprintAlgorithm;
  duration: number;
...
export interface TagEdit_tagEdit_old_details_SceneEdit_added_fingerprints {
  __typename: "Fingerprint";
  hash: string;
  algorithm: FingerprintAlgorithm;
  duration: number;
...
export interface TagEdit_tagEdit_old_details_SceneEdit_removed_fingerprints {
  __typename: "Fingerprint";
  hash: string;
  algorithm: FingerprintAlgorithm;
  duration: number;
...
export interface TagEdit_tagEdit_merge_sources_Scene_date {
  __typename: "FuzzyDate";
  date: any;
  accuracy: DateAccuracyEnum;
}
...
export interface TagEdit_tagEdit_merge_sources_Scene {
  __typename: "Scene";
  id: string;
  date: TagEdit_tagEdit_merge_sources_Scene_date | null;
  title: string | null;
  deleted: boolean;
  details: string | null;
  director: string | null;
