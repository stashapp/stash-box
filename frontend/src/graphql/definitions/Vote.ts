...
export interface Vote_editVote_target_Scene_date {
  __typename: "FuzzyDate";
  date: any;
  accuracy: DateAccuracyEnum;
}
...
export interface Vote_editVote_target_Scene {
  __typename: "Scene";
  id: string;
  date: Vote_editVote_target_Scene_date | null;
  title: string | null;
  deleted: boolean;
  details: string | null;
...
export interface Vote_editVote_merge_sources_Scene_date {
  __typename: "FuzzyDate";
  date: any;
  accuracy: DateAccuracyEnum;
}
...
export interface Vote_editVote_merge_sources_Scene {
  __typename: "Scene";
  id: string;
  date: Vote_editVote_merge_sources_Scene_date | null;
  title: string | null;
  deleted: boolean;
  details: string | null;
  director: string | null;
