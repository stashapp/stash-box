...
type NotificationType = NotificationsQuery["queryNotifications"]["notifications"][number];
...
const headers = {
  ...
  'UpdatedEdit': 'And edit you voted on was updated',
...
export const Notification: React.FC<Props> = ({ notification }) => {
  return <div className="notification">{ renderNotificationBody(notification) }</div>
}
