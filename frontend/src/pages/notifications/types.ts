...
export const isCommentNotification = (notification: NotificationType): notification is CommentNotificationType => (
...
export const isEditNotification = (notification: NotificationType): notification is EditNotificationType => (
...
export const isSceneNotification = (notification: NotificationType): notification is SceneNotificationType => (
