...
func (s *testRunner) readGroups() []models.ImageTypeGroup {
	s.t.Helper()
...
func (s *testRunner) restoreOrder(groups []models.ImageTypeGroup) {
...
func (s *imageTypeTestRunner) testImageTypeGroups() {
	...
	assert.Equal(s.t, 27, seededTypes)
}
...
func (s *testRunner) restoreEnabled() {
